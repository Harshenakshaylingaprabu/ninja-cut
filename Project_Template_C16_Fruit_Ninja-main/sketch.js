...
var knifeImage ,fruitslashSound,gameoverSound, fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage;
...
function preload(){
  ...
  fruitslashSound=loadSound("knifeSwoosh.mp3")
}
